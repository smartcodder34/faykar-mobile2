...
const LoginScreen = () => {
  ...
  const forgotPasswordRef = React.useRef<BottomSheetScreenRef>(null);
  ...
  const resetPasswordRef = React.useRef<BottomSheetScreenRef>(null);
  //close the bottom sheet
  ...
  const signIn = async () => {
    try {
      ...
      if (isSuccessResponse(response)) {
        ...
        console.log("User google login Info --> ", response.data);
